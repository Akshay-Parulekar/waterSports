...
//
//public class HelperWith4Columns
//{
...
//
//    public static int PrintBill(String title, String header, String footer, String address, String contact, String printerName, Long billNo, String serialNo, String referee, String customerName, String activities, Integer nPerson, Double rate, String date, List<OrderDetailsWaterSport> listOrderDet)
//    {
//        // Setup Printer
...
//
//        middleSpace = maxChars - ("SrNo : " + serialNo).length() - ("Ref : " + referee).length();
//        String strSrNoRef = String.format("%s%" + middleSpace + "s%s", "SrNo : " + serialNo, "", "Ref : " + referee + "\n");
//        expected.writeBytes((strSrNoRef).getBytes());
//
